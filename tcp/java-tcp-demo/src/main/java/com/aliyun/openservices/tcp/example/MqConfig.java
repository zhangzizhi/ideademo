...
public class MqConfig {
     ...
     */
    public static final String TOPIC = "testjoyi";
    public static final String PRODUCER_ID = "PID_JOYI";
    public static final String CONSUMER_ID = "CID_JOYI_YYY";
    ...
    public static final String ACCESS_KEY = "LTAIxccL986btvyY";
    public static final String SECRET_KEY = "KUn0OHyQmtHT65i7pBEvziJXq204wL";
